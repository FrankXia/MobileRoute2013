...
@synthesize legendTableView;
@synthesize legendInfos;
...
- (void) reload {
	[self.legendTableView performSelectorOnMainThread:@selector(reloadData) withObject:nil waitUntilDone:NO];
}
...
- (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView {
	self.legendTableView = tableView;
	return 1;
}
